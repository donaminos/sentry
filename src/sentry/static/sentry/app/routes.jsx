...
const orgSettings = [
  ['/organizations/:orgId/audit-log/', OrganizationAuditLog],
  ['/organizations/:orgId/integrations/', OrganizationIntegrations],
  ['/organizations/:orgId/rate-limits/', OrganizationRateLimits],
  ['/organizations/:orgId/repos/', OrganizationRepositories],
  ...
  return (
    <Route path="/" component={errorHandler(App)}>
      ...
      <Route path="/:orgId/" component={errorHandler(OrganizationDetails)}>
        ...
        <Route
          path={`/organizations/:orgId/(${orgSettingsPaths.join('|')})`}
          component={OrganizationHomeContainer}>
          {orgSettings.map(([path, Component]) => (
            <Route key={path} path={path} component={errorHandler(Component)} />
          ))}
        </Route>
